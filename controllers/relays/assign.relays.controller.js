...
export const nextCountry = async (req, res, next) => {
    try {
        ...
        const nextCountries = await assignService.getNextCountries(user_id, relay_id);
...
export const countryConfirm = async (req, res, next) => {
    try {
        ...
        const confirmedCountry = await assignService.confirmCountry(user_id, relay_id, next_country_id);
