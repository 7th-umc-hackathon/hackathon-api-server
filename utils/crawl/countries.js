...
/*
common_name, ccn3, cca3, timezones, national_flag_url 수집
*/
  ...
  try {
    const countries = allCountries
      .map((country) => ({
        ...
        national_flag_url: country.flags.png,
      }))
      .filter(
        (country) =>
          country.common_name &&
...
//       common_name: country?.name?.common || "N/A",
//       ccn3: country?.ccn3 || "N/A",
//       cca3: country?.cca3 || "N/A",
//       timezones: country?.timezones || [],
//       national_flag_url: country?.flags?.png || "N/A",
//     }));
...
//   console.log(countries[0]); // 첫 번째 국가 정보 출력
// });
...
seedCountries().then(() => console.log("Seed complete!"));
